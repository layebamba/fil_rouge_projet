...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/api/compte' => [[['_route' => 'compte', '_controller' => 'App\\Controller\\CompteController::compte'], null, ['GET' => 0], null, false, false, null]],
        '/api/partenaire' => [[['_route' => 'partenaire', '_controller' => 'App\\Controller\\PartenaireController::new'], null, ['POST' => 0], null, false, false, null]],
...
>>>>>>> 411769a7473937fd2dd8918b2f87d0cdd46d83cc
    ...
    [ // $dynamicRoutes
        ...
        65 => [[['_route' => 'updateuser', '_controller' => 'App\\Controller\\SecurityController::update'], ['id'], ['PUT' => 0], null, false, true, null]],
